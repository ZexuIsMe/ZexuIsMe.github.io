...
只有在对象具有 `__enter__()` 和 `__exit__()` 方可使用





## Question: 库的安装，为什么会有先安装低版本，再安装高版本的操作？

因为Python的高版本可能已经没有低版本支持的模块，但又需要高版本的版本中的模块去支持其他功能，所以才有这样的操作。
