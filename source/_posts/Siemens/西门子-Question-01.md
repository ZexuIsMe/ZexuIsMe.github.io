...
![由于不满足前提条件，将不执行下载](../../images/西门子-Question-01/由于不满足前提条件，将不执行下载.png)
检查项目的设备信息，核对设备型号，功率单元是否正确

##### <span style="color: #cc0033">Q：如何判断电机是什么类型的电机？</span> ^未回答^
![如何判断电机是什么类型的电机](../../images/西门子-Question-01/如何判断电机是什么类型的电机.png)
> 有这么多电机，它们是如何辨别出来的？

##### <span style="color: #cc0033">Q：MOVE传值给的16进制，得到的为什么是负值？</span> ^MOVE^ ^负值^
![MOVE传值给的16进制](../../images/西门子-Question-01/MOVE传值给的16进制.png)
...
![为什么FB块中明明是INOUT](../../images/西门子-Question-01/为什么FB块中明明是INOUT_01.png)
![为什么FB块中明明是INOUT](../../images/西门子-Question-01/为什么FB块中明明是INOUT_02.png)
![为什么FB块中明明是INOUT](../../images/西门子-Question-01/为什么FB块中明明是INOUT_03.png)
...
![为什么FB块中明明是INOUT](../../images/西门子-Question-01/为什么FB块中明明是INOUT_04.png)
![为什么FB块中明明是INOUT](../../images/西门子-Question-01/为什么FB块中明明是INOUT_05.png)
这样就能达到预期的效果
...
- `Bit2~8`：表示下标2~下标8之间地址
  ![bit0~1.png](../../images/西门子-Question-01/MOVE传值给的16进制.png)
