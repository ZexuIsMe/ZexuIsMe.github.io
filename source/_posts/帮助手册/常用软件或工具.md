...
class GongJuMd {
    constructor() {
        ...
        this.tbody1 = [
            ...
            { name: 'SQL基础学习', link: 'https://www.runoob.com/sql/sql-where.html', free: true, desc: '菜鸟教程' },
            { name: '炼码', link: 'https://www.lintcode.com/', free: true, desc: '刷题，有VIP' },
            { name: 'Selenium', link: 'https://seleniumbase.io/demo_page', free: true, desc: '练习 Selenium 的页面' },
        ];
        // 资源库
        this.tbody2 = [
            ...
            { name: '字体包', link: 'https://www.fonts.net.cn', free: true, desc: '免费字体', type: '字体包' },
            { name: '外链图册：PicGo', link: 'https://www.picgo.net/', free: true, desc: '外链图册', type: '外链图册' },
        ...
        this.tbody3 = [
            ...
            { name: '阿里云盘', link: 'https://www.alipan.com/', free: true, desc: '阿里云网盘，好用' },
            { name: '谷歌浏览器', link: 'https://www.google.cn/intl/zh-CN/chrome/', free: true, desc: '现在连官网都不好找了...咱国内的广告真的是无孔不入' },
